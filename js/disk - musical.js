...
const linkList = [
    "MusicalHtml/English.html",
    "MusicalHtml/French.html",
    "MusicalHtml/German.html",
    "MusicalHtml/Russian.html"
];
...
function init_disk() {
    ...
    disk.style.backgroundImage = "radial-gradient(" + DISK_WIDTH + "px " + DISK_RADIUS + "px" + ",#561E0D 15%, #CAC4B7 20%, #561E0D 25%, #CAC4B7 30%, #CAC4B7 40%, #561E0D 41%, #CAC4B7 45%, #CAC4B7 90%, #561E0D 95%)";
