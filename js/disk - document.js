...
const linkList = [
    "DocumentaryHtml/Poetic/Rain.html",
    "DocumentaryHtml/Expository/Ordinary Fascism.html",
    "DocumentaryHtml/Observational/yinyang.html",
    "DocumentaryHtml/Participatory/Summer.html",
    "DocumentaryHtml/Reflexive/xymn.html",
    "DocumentaryHtml/Performance/Tongues.html"
];
...
function init_disk() {
    ...
    disk.style.backgroundImage = "radial-gradient(" + DISK_WIDTH + "px " + DISK_RADIUS + "px" + ", #293719 15%, #CAC4B7 20%, #293719 25%, #CAC4B7 30%, #CAC4B7 40%, #293719 41%, #CAC4B7 45%, #CAC4B7 90%, #293719 95%)";
